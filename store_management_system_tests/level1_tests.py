...
def run_level1_tests(with_authentication, authentication_url, customer_url, with_blockchain, customer_keys_path,
                     customer_passphrase, owner_private_key, provider_url):
    tests = [
        # Tests 1 - 11
        # These tests evaluate all possible errors that can occur when processing order requests 
        ["post", customer_url + "/order", set_up_authorization_error_request(with_authentication), {}, {}, {}, 401,
         {"msg": "Missing Authorization Header"}, equals, 1],
        ["post", customer_url + "/order", set_up_owner_headers(with_authentication, authentication_url), {}, {}, {},
         401, {"msg": "Missing Authorization Header"}, equals, 1],
        ["post", customer_url + "/order", set_up_user_headers(with_authentication, False, authentication_url), {}, {},
         {}, 401, {"msg": "Missing Authorization Header"}, equals, 1],
        ["post", customer_url + "/order", set_up_user_headers(with_authentication, True, authentication_url), {}, {},
         {}, 400, {"message": "Field requests is missing."}, equals, 1],
        ["post", customer_url + "/order", set_up_user_headers(with_authentication, True, authentication_url), {},
         get_order_error0(), {}, 400, {"message": "Product id is missing for request number 0."}, equals, 1],
        ["post", customer_url + "/order", set_up_user_headers(with_authentication, True, authentication_url), {},
         get_order_error1(), {}, 400, {"message": "Product quantity is missing for request number 1."}, equals, 1],
        ["post", customer_url + "/order", set_up_user_headers(with_authentication, True, authentication_url), {},
         get_order_error2(), {}, 400, {"message": "Invalid product id for request number 0."}, equals, 1],
        ["post", customer_url + "/order", set_up_user_headers(with_authentication, True, authentication_url), {},
         get_order_error3(), {}, 400, {"message": "Invalid product id for request number 0."}, equals, 1],
        ["post", customer_url + "/order", set_up_user_headers(with_authentication, True, authentication_url), {},
         get_order_error4(), {}, 400, {"message": "Invalid product quantity for request number 0."}, equals, 1],
        ["post", customer_url + "/order", set_up_user_headers(with_authentication, True, authentication_url), {},
         get_order_error5(), {}, 400, {"message": "Invalid product quantity for request number 0."}, equals, 1],
        ["post", customer_url + "/order", set_up_user_headers(with_authentication, True, authentication_url), {},
         get_order_error6(), {}, 400, {"message": "Invalid product for request number 0."}, equals, 1],
        ...
        ["post", customer_url + "/order",
         set_up_user_headers_with_blockchain(with_authentication, True, authentication_url, with_blockchain, None), {},
         get_order_error7(), {}, 400, {"message": "Field address is missing."}, equals, 1],
        ["post", customer_url + "/order",
         set_up_user_headers_with_blockchain(with_authentication, True, authentication_url, with_blockchain, ""), {},
         get_order_error7(), {}, 400, {"message": "Field address is missing."}, equals, 1],
        ["post", customer_url + "/order",
         set_up_user_headers_with_blockchain(with_authentication, True, authentication_url, with_blockchain, "asdasd"),
         {}, get_order_error7(), {}, 400, {"message": "Invalid address."}, equals, 1],
        ...
        ["post", customer_url + "/order",
         set_up_order_test(with_authentication, authentication_url, customer_url, with_blockchain, customer_keys_path,
