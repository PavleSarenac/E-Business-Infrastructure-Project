...
def run_level0_tests(with_authentication, authentication_url, owner_url, customer_url):
    tests = [
        ...
        ["post", owner_url + "/update", set_up_authorization_error_request(with_authentication), {}, {}, {}, 401,
         {"msg": "Missing Authorization Header"}, equals, 1],
        ["post", owner_url + "/update", set_up_user_headers(with_authentication, True, authentication_url), {}, {}, {},
        ...
        ["post", owner_url + "/update", set_up_update_test(with_authentication, authentication_url, get_csv_error1()),
         {}, {}, {}, 400, {"message": "Incorrect price on line 1."}, equals, 1],
        ["post", owner_url + "/update", set_up_update_test(with_authentication, authentication_url, get_csv_error2()),
         {}, {}, {}, 400, {"message": "Incorrect price on line 1."}, equals, 1],
        ...
        ["get", customer_url + "/search", set_up_authorization_error_request(with_authentication), {}, {}, {}, 401,
         {"msg": "Missing Authorization Header"}, equals, 1],
        ["get", customer_url + "/search", set_up_owner_headers(with_authentication, authentication_url), {}, {}, {},
         401, {"msg": "Missing Authorization Header"}, equals, 1],
        ["get", customer_url + "/search", set_up_user_headers(with_authentication, False, authentication_url), {}, {},
         {}, 401, {"msg": "Missing Authorization Header"}, equals, 1],

        # Tests 11 - 12
        # These tests evaluate update and empty search requests
        ["post", owner_url + "/update", set_up_update_test(with_authentication, authentication_url, get_data0()), {},
         {}, {}, 200, None, equals, 1],

        ["get", customer_url + "/search", set_up_user_headers(with_authentication, True, authentication_url), {}, {},
         {}, 200, get_search_result0(), evaluate_search_test, 7],

        # Tests 13 - 14
        # These tests evaluate an invalid update and empty search requests
        ["post", owner_url + "/update", set_up_update_test(with_authentication, authentication_url, get_csv_error3()),
         {}, {}, {}, 400, {"message": "Product Product0 already exists."}, equals, 1],
        ...
        ["get", customer_url + "/search",
         set_up_search_test(with_authentication, authentication_url, get_search_parameters1()), {}, {}, {}, 200,
         get_search_result1(), evaluate_search_test, 3],
        ["get", customer_url + "/search",
         set_up_search_test(with_authentication, authentication_url, get_search_parameters2()), {}, {}, {}, 200,
         get_search_result2(), evaluate_search_test, 3],
        ["get", customer_url + "/search",
         set_up_search_test(with_authentication, authentication_url, get_search_parameters3()), {}, {}, {}, 200,
         get_search_result3(), evaluate_search_test, 3],
        ["get", customer_url + "/search",
         set_up_search_test(with_authentication, authentication_url, get_search_parameters4()), {}, {}, {}, 200,
         get_search_result4(), evaluate_search_test, 3],
    ]
